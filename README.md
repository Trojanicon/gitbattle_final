...
Backend: Mostly functional (Node.js/Express). OAuth and point calculations are logic-ready.

Frontend: Flutter-based. UI is mostly there, but deep linking and the actual data sync are currently buggy. * Known Issues: The GitHub OAuth callback sometimes hangs on mobile, and I'm still tuning the "Commit Monster" logic.
...
Database: MongoDB. It stores user stats, friend lists, and active "Battle" challenges.
